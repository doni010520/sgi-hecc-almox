          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Paciente, prontuário, prescritor..."
                  ...
                  <button
                    ...
                    <div className="flex-1 min-w-0 grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-1">
                      ...
                      <div className="col-span-1">
                        <p className="text-xs" style={{ color: txtMut }}>Paciente</p>
                      ...
                      <div className="hidden md:block">
                        <p className="text-xs" style={{ color: txtMut }}>Prescritor</p>
                        <p className="text-sm truncate" style={{ color: txt }}>{d.prescribing_doctor}</p>
                      </div>
                      <div>
